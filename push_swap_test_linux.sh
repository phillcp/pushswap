...
echo RANDOM TEST WITH BIG NUMS
echo TEST 1 ARG:"$ARG" >> traces.txt
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
...
ARG=$(seq -2147483648 -2147483149 | shuf | tr '\n' ' ')
echo TEST 2 ARG:"$ARG" >> traces.txt
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
elif [ $N -gt 5500 ] && [ $N -lt 7000 ]; then
...
echo TEST 3 ARG:"$ARG" >> traces.txt
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
elif [ $N -gt 5500 ] && [ $N -lt 7000 ]; then
...
ARG=$(seq 0 499 | shuf | tr '\n' ' ');
echo TEST 4 ARG:"$ARG" >> traces.txt
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
elif [ $N -gt 5500 ] && [ $N -lt 7000 ]; then
...
ARG=$(seq 0 499 | shuf | tr '\n' ' ');
echo TEST 5 ARG:"$ARG" >> traces.txt
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
elif [ $N -gt 5500 ] && [ $N -lt 7000 ]; then
...
echo TEST 6 ARG:"$ARG" >> traces.txt
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
elif [ $N -gt 5500 ] && [ $N -lt 7000 ]; then
